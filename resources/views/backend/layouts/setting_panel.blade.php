<div class="hk-settings-panel">
    <div class="nicescroll-bar position-relative">
        <div class="settings-panel-wrap">
            <div class="settings-panel-head">
                <img class="brand-img d-inline-block align-top" src="{{ asset('backend/dist/img/logo-light.png') }}" alt="brand" />
    ...
    <img class="d-none" src="{{ asset('backend/dist/img/logo-light.png') }}" alt="brand" />
    <img class="d-none" src="{{ asset('backend/dist/img/logo-dark.png') }}" alt="brand" />
</div>
