                                    ...
                                    @foreach($categories as $index => $category)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#delete_category_{{ $index }}"> <i class="icon-trash txt-danger"></i> </a>
                                                @include('backend.includes.modal_delete_confirm', ['index' => $index, 'category' => $category])
                                            </td>
                                        </tr>
                                    @endforeach
                                    @if(!count($categories))
